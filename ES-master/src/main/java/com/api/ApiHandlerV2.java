...
/**
 * Resource exposed at "v2" path. This class handles API
 * support for 'git.dei.uc.pt'.
 */
@Path("v2/projects/{project_id}")
public class ApiHandlerV2 {

    private static final Logger LOGGER = LogManager.getLogger(ApiHandlerV2.class);

    private static final String DEFAULT_PARAM_VALUE = "NULL";
    private static final String DEFAULT_MAX_COMMIT_VALUE = "20";

    private static final String API_TREE_REQUEST_FORMAT = "https://git.dei.uc.pt/api/v3/projects/%s/repository/tree/?private_token=%s";
    private static final String API_SUBTREE_REQUEST_FORMAT = API_TREE_REQUEST_FORMAT + "&path=%s";

    private static final String API_COMMIT_PAGE_REQUEST_FORMAT = "https://git.dei.uc.pt/api/v3/projects/%s/repository/commits/?private_token=%s&page=%d";
    private static final String API_COMMIT_INFO_REQUEST_FORMAT = "https://git.dei.uc.pt/api/v3/projects/%s/repository/commits/%s/diff/?private_token=%s";
